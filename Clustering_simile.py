...
class Clustering_simile:
    def __init__(self):
        ...
        s.clustering(self, clusters = 4, filenames= main.filenames, size_figure = (8, 6), random_state = 170, max_iter = 1000)
